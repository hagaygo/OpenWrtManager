...
class SystemInfo extends OverviewWidgetBase {
  SystemInfo(Device device, bool loading, AuthenticateReply authenticationStatus, List<CommandReplyBase> replies,
...
class SystemInfoState extends OverviewWidgetBaseState with TickerProviderStateMixin {
  @override
  ...
  Widget get myWidget {
    ...
    var memoryUsed =
        memoryTotal - infoData["memory"]["free"] - infoData["memory"]["cached"] - infoData["memory"]["buffered"];
    ...
    var alwaysVisibleRows = getRows({
      ...
      "Memory Usage":
          (memoryUsed / 1024 / 1024).toStringAsFixed(2) + "MB/" + (memoryTotal / 1024 / 1024).toStringAsFixed(2) + "MB"
    });
